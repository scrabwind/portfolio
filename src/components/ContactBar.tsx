...
import type { ContactIcon, ContactItem } from "../i18n/home";
...
function ContactIconLink({ item }: { item: ContactItem }) {
  ...
  return (
    ...
    >
      <a
        ...
        className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-brand-border bg-brand-bg-alt text-brand-muted transition hover:-translate-y-0.5 hover:border-brand-accent-cyan hover:text-brand-accent-cyan"
      >
        {icons[item.icon]}
      </a>
      {open && (
